  ...
  "relative inline-flex items-center justify-center gap-2 rounded-full font-medium tracking-tight transition-all duration-300 ease-out disabled:opacity-50 disabled:pointer-events-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ms-gold-700 focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        primary:
          "bg-ms-black text-white shadow-[0_1px_0_rgba(255,255,255,0.08)_inset,0_10px_24px_-8px_rgba(11,13,12,0.45)] hover:bg-ms-gold-900 hover:shadow-[0_1px_0_rgba(255,255,255,0.15)_inset,0_16px_32px_-8px_rgba(138,109,31,0.5)] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]",
        ...
        secondary:
          "bg-ms-gold-700 text-ms-black shadow-[0_1px_0_rgba(255,255,255,0.25)_inset,0_10px_24px_-8px_rgba(138,109,31,0.45)] hover:brightness-95 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]",
        outline:
