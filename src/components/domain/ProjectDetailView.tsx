...
/**
 * Corpo visual completo da página de um empreendimento — usado tanto pela
 * rota pública (/investimentos/[slug], que só exibe empreendimentos ativos)
 * quanto pela prévia do admin (/admin/empreendimentos/[id]/preview, que
 * mostra o mesmo layout mesmo quando o empreendimento ainda está inativo).
 */
    ...
    <div>
      ...
      {project.additionalInfo && (
        <section className="mx-auto max-w-6xl px-5 pb-16 sm:px-8 sm:pb-20">
          ...
          <p className="mt-4 max-w-3xl whitespace-pre-line leading-relaxed text-ms-gray-500">
            {project.additionalInfo}
          </p>
        </section>
      )}
      ...
      <section className="grain relative overflow-hidden bg-ms-black py-20 text-center text-white sm:py-28">
        ...
        <div className="relative mx-auto max-w-2xl px-5 sm:px-8">
          ...
          <div className="mt-9 flex justify-center">
            <InvestButton project={project} label={project.ctaText} />
          </div>
